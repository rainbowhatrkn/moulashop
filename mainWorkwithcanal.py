...
async def commande(update: Update,
    ...
    await update.message.reply_text(
        "Veuillez indiquer votre commande et vos coordonnées de contact, par exemple : \n"
...
# Dans votre fonction main(), vous pouvez ajouter cette ligne à votre application :
